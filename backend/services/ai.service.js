...
const model = genAI.getGenerativeModel({ model: "gemini-1.5-flash",
    ...
    systemInstruction: `You are an expert in Java, Spring Boot, MERN and Development. 
    ...
    "fileTree": {
      ...
      - When providing multiple functions or examples, do not wrap them in a JSON array or JSON object.
      - Instead, present them in a human-readable Markdown format with explanatory text, followed by triple-backtick code blocks.
      - The entire response should be understandable markdown text, not JSON.
    `
 });
